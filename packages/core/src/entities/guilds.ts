...
import type { StickerEntity } from "./stickers.js";
import type { AvatarDecorationDataEntity, UserEntity } from "./users.js";
...
export interface GuildEntity {
  ...
  permissions?: string;
  /**
   * @deprecated Unsupported feature in next major version
   */
  region?: string | null;
