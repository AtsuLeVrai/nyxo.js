...
export enum ApiVersion {
  /**
   * @deprecated Use {@link ApiVersion.V10} instead - Version 3 has been deprecated
   */
  V3 = 3,
  /**
   * @deprecated Use {@link ApiVersion.V10} instead - Version 4 has been deprecated
   */
  V4 = 4,
  /**
   * @deprecated Use {@link ApiVersion.V10} instead - Version 5 has been deprecated
   */
  V5 = 5,
  /**
