...
import { ComponentType, UserSelectMenuBuilder } from "../src/index.js";

describe("UserSelectMenuBuilder", () => {
  let builder: UserSelectMenuBuilder;
  ...
  describe("constructor", () => {
    it("should create a default user select menu", () => {
    ...
    it("should initialize with provided data", () => {
      ...
      const customBuilder = new UserSelectMenuBuilder(initialData);
  ...
  describe("static from", () => {
    it("should create a builder from an existing user select menu", () => {
      const menu = {
        type: ComponentType.UserSelect,
        custom_id: "test-menu",
        placeholder: "Select users",
      ...
      // @ts-expect-error Testing invalid input
      const newBuilder = UserSelectMenuBuilder.from(menu);
  ...
  describe("setPlaceholder", () => {
    it("should set the placeholder", () => {
      builder.setPlaceholder("Select users");

      expect(builder.toJson().placeholder).toBe("Select users");
    });
  ...
  describe("setDefaultUsers", () => {
    it("should set default users, replacing existing ones", () => {
      // Add initial default users
      builder.addDefaultUsers("111111111", "222222222");

      // Replace with new defaults
      builder.setDefaultUsers("333333333", "444444444");
  ...
  describe("addDefaultValues", () => {
    it("should add default values", () => {
      const defaults = [
        ...
        { id: "987654321", type: "user" as const },
      ];
    ...
    it("should throw with invalid default values", () => {
      expect(() =>
        ...
        builder.addDefaultValues({ id: "123456789", type: "role" as any }),
      ).toThrow();
    });
  });
  ...
  describe("setDefaultValues", () => {
    it("should set default values, replacing existing ones", () => {
      ...
      builder.addDefaultValues(
        ...
        { id: "222222222", type: "user" as const },
      );

      // Replace with new defaults
      const newDefaults = [
        { id: "333333333", type: "user" as const },
        { id: "444444444", type: "user" as const },
      ];
  ...
  describe("build", () => {
    it("should return the validated user select menu", () => {
      builder
  ...
  describe("isValid", () => {
    it("should return true for valid user select menu", () => {
      builder.setCustomId("test-menu");

      expect(builder.isValid()).toBe(true);
    });

    it("should return false for invalid user select menu", () => {
