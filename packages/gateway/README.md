...
`@nyxojs/gateway` is a robust WebSocket client for Discord's Gateway API, designed for reliability and scalability. It
handles complex operations like connection lifecycle management, heartbeats, sharding, and reconnection logic with type
safety at its core.

> [!NOTE]
> This package is part of the Nyxo.js ecosystem but can be used independently with your own Discord bot implementations.
