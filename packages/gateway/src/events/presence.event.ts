 ...
 */
export const ActivityButtonsEntity = z
  .object({
    label: z.string(),
    url: z.string().url(),
  })
 ...
 */
export const ActivitySecretsEntity = z
  .object({
 ...
 */
export const ActivityAssetImageEntity = z
  .object({
 ...
 */
export const ActivityPartyEntity = z
  .object({
 ...
 */
export const ActivityEmojiEntity = z
  .object({
    name: z.string(),
 ...
 */
export const ActivityTimestampsEntity = z
  .object({
 ...
 */
export const ClientStatusEntity = z
  .object({
