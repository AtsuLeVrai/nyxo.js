import type { InteractionResponseModalStructure } from "@nyxjs/core";
...
const DEFAULT_VALUES: InteractionResponseModalStructure = {
    custom_id: "",
    title: "",
    components: [],
};
...
export class ModalBuilder extends ActionRowBuilder<TextInputBuilder> {
    private readonly data: InteractionResponseModalStructure;

    public constructor(data: Partial<InteractionResponseModalStructure> = {}) {
        super();
