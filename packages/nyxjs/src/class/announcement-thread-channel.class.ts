...
export class AnnouncementThreadChannel extends BaseClass<AnnouncementThreadChannelEntity> {
  readonly #flags: BitFieldManager<ChannelFlags>;

  constructor(
    client: Client,
    entity: Partial<z.input<typeof AnnouncementThreadChannelEntity>> = {},
  ) {
    super(client, AnnouncementThreadChannelEntity, entity);
  ...
  get type(): ChannelType.AnnouncementThread {
  ...
  get defaultSortOrder(): SortOrderType | null {
    return this.entity.default_sort_order
      ? this.entity.default_sort_order
      : null;
  }
