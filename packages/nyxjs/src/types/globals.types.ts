...
export interface ClientEvents extends RestEvents, GatewayEvents {
  /**
   * Emitted when a debug message is generated by the client.
   * @param message The debug message
   */
  debug: [message: string];

  /**
   * Emitted when a warning occurs during client operation.
  ...
  /**
   * Emitted in response to a successful session resume.
   * Occurs when the client reconnects and resumes a dropped connection.
   * @param resumed Information about the resumed session
   */
