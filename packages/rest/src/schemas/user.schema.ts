 ...
 */
export const ModifyCurrentUserEntity = z.object({
 ...
 */
export const GetCurrentUserGuildsQueryEntity = z.object({
 ...
 */
export const CreateGroupDmEntity = z.object({
 ...
 */
export const UpdateCurrentUserApplicationRoleConnectionEntity = z.object({
