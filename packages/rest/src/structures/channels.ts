...
export type ThreadMemberStructure = {
	 ...
	 */
	join_timestamp: IsoO8601Timestamp;
	/**
...
export type ThreadMetadataStructure = {
	 ...
	 */
	archive_timestamp: IsoO8601Timestamp;
	/**
	 ...
	 */
	create_timestamp?: IsoO8601Timestamp | null;
	/**
...
export type ChannelStructure = {
	...
	owner_id?: Snowflake;
	/**
	 * For guild channels: id of the parent category for a channel (each parent category can contain up to 50 channels), for threads: id of the text channel
	 */
