...
describe("HeaderHandler", () => {
  ...
  describe("internal utility methods", () => {
    describe("fromArray", () => {
      it("should convert string arrays to record objects", () => {
        const headers = [
          "Content-Type",
          "application/json",
          "X-Custom",
        ...
        const result = HeaderHandler.fromArray(headers);
      ...
      it("should handle incomplete pairs by skipping them", () => {
        const headers = ["Key1", "Value1", "Key2"];
        const result = HeaderHandler.fromArray(headers);
    ...
    describe("fromIterable", () => {
      it("should convert iterables to record objects", () => {
        // @ts-expect-error
        const headers = new Map([
          ["Content-Type", "application/json"],
          ["X-Custom", ["value1", "value2"]],
        ...
        // Add a second value for X-Multiple to test merging
        headers.set("X-Multiple", "value2");

        const result = HeaderHandler.fromIterable(headers);
