 ...
 * @throws Will throw an error if the encoding type is unsupported or if decoding fails.
 */
 ...
 * @throws Will throw an error if the encoding type is unsupported or if encoding fails.
 */
