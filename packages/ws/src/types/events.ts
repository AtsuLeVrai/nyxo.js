...
export type GatewayReceiveEvents = {
	...
	GUILD_CREATE: [
		guildCreate:
			| UnavailableGuildStructure
			| (GuildCreateExtraFields & GuildStructure),
	];
	...
	GUILD_MEMBER_ADD: [
		guildMemberAdd: GuildMemberAddEventFields & GuildMemberStructure,
	];
	...
	INTEGRATION_UPDATE: [
		integrationUpdate: IntegrationStructure &
			IntegrationUpdateEventAdditionalFields,
	];
	...
	VOICE_CHANNEL_EFFECT_SEND: [
		voiceChannelEffectSend: VoiceChannelEffectSendEventFields,
	];
