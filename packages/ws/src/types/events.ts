...
export type GatewayReceiveEvents = {
	...
	"APPLICATION_COMMAND_PERMISSIONS_UPDATE": [applicationCommandPermissionsUpdate: GuildApplicationCommandPermissionsStructure];
	...
	"GUILD_AUDIT_LOG_ENTRY_CREATE": [guildAuditLogEntryCreate: AuditLogEntryStructure & GuildAuditLogEntryCreateEventExtraFields];
