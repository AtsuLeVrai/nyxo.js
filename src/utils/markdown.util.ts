...
export type FormattedUser = `<@${string}>`;
export function formatUser(userId: string): FormattedUser {
  return `<@${userId}>`;
}

export type FormattedChannel = `<#${string}>`;
export function formatChannel(channelId: string): FormattedChannel {
  return `<#${channelId}>`;
}

export type FormattedRole = `<@&${string}>`;
export function formatRole(roleId: string): FormattedRole {
  return `<@&${roleId}>`;
}
...
export type FormattedCustomEmoji = `<:${string}:${string}>` | `<a:${string}:${string}>`;
...
export type FormattedGuildNavigation = `<${string}:${GuildNavigationType}>`;
